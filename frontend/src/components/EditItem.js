...
const EditItem = () => {
    const {name,address,id,salary,dob,handleNameChange,
        handleIdChange,handleAddressChange,handleDobChange,handleSalaryChange,onEditSubmit}=useContext(DataContext)
  return (
    <form className='m-3 p-2 pt-4'>
        ...
        <button type="button" onClick={onEditSubmit} className="btn btn-primary">Edit Data</button>
